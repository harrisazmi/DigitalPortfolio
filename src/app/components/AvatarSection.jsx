    ...
    <section className="lg:py-32 ">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link href="/#contact">
              <div className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 text-white">
                Hire Me
              </div>
            </Link>
            <Link href="/Harris_Azmi_Resume.pdf">
