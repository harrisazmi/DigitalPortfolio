...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    { url: `${BASE_URL}/home`, lastModified: new Date(), changeFrequency: 'monthly', priority: 1.0 },
    ...
    { url: `${BASE_URL}/contacts`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.5 },
  ]
