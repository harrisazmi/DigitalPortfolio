...
export const AvatarInfo: AvatarLinkType[] = [
  {
...
export const AvatarDesignation: AvatarDesignationListType = [
...
export const AvatarUsername: AvatarUsernameType = "Harris Azmi";
